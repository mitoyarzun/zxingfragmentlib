...
//    resultView = getView().findViewById(R.id.result_view);
 ...
 * @author Sean Owen
 */
//public class BarCodeScannerFragment extends Fragment implements SurfaceHolder.Callback, IZXingConstants {
//
//    private static final String TAG = BarCodeScannerFragment.class.getSimpleName();
//
//    private static final long DEFAULT_INTENT_RESULT_DURATION_MS = 1500L;
